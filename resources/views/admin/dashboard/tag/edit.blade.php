 ...
 <div class="main-content">
    <section class="section">
      <div class="section-header">
        <h1>Merubah Data Tag</h1>
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
          <div class="breadcrumb-item"><a href="#">Forms</a></div>
          <div class="breadcrumb-item">Merubah Data Tag</div>
        </div>
      </div>

      <div class="section-body">
        <h2 class="section-title">Merubah Data Tag</h2>
                ...
                <form action="{{route('admin.tag.update',$tag->id)}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text"  value="{{$tag->tag}}" name="tag"  class="form-control phone-number">
                    </div>
                  </div>                     
