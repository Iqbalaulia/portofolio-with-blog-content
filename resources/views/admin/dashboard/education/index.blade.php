    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Table Pendidikan</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Table Pendidikan</h2>
            <p class="section-lead">Pendidikan saya selama saya hidup</p>
            <div class="button-create w-100 mb-5" align="right">
                <a href="{{route('admin.education.create')}}" class="btn btn-icon icon-left btn-success px-5"><i
                                        ...
                                        <td>
                                            ...
                                            <div class="row">
                                                <a href="{{ route('admin.education.edit',$education->id) }}"
                                                    class="ml-2 ">
                                                    <button type="button" class="btn btn-icon icon-left btn-primary"><i
                                                ...
                                                <a href="" class="" data-toggle="modal"
                                                    ...
                                                    <button type="button" class="btn btn-icon icon-left btn-danger"><i
