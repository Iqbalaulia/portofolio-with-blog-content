	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(user/images/;">
	          		<div class="overlay"></div>
	          	</div>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url({{ URL::to('/') }}/admin/images/{{ $profileUser->photo }});">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
				  ...
				  <p>{{$profileDetail['about_me']}}</p>
					...
					<li class="d-flex"><span>Name:</span> <span>{{$profileUser['name']}}</span></li>
		            	<li class="d-flex"><span>Date of birth:</span> <span>{{ date('d M Y', strtotime($profileDetail['date_birth'])) }}</span></li>
		            	<li class="d-flex"><span>Address:</span> <span>{{ $profileDetail['address'] }}</span></li>
		            	<li class="d-flex"><span>Country:</span> <span>{{ $profileDetail['country'] }}</span></li>
